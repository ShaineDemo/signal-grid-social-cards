...
def validate(root: Path) -> None:
    ...
    for marker in (
        ...
        'data-role="source-footer"',
        'data-cover-asset-availability="not-needed"',
        'data-cover-asset-reason=',
        "palette-violet-moss",
    ...
    for marker in (
        ...
        'data-role="page-number"',
        'data-role="source-footer"',
        'data-role="product-comparison"',
        'data-comparison-kind="price"',
        ...
        'data-test-metric=',
        'data-test-context=',
        'Cover asset availability:',
        'Cover asset decision:',
        'Cover asset reason:',
    ):
